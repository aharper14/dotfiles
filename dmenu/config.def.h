...
#if PANGO_PATCH
static char font[] = "JetBrains Mono 10";
#else
#if XRESOURCES_PATCH
static char *fonts[] =
#else
...
char *colors[][2] = {
	...
	[SchemeSel]  = { "#585b70", "#f9e2af" },
	[SchemeOut]  = { "#000000", "#00ffff" },
	#if BORDER_PATCH
	[SchemeBorder] = { "#f5c2e7", "#f5c2e7" },
	#endif // BORDER_PATCH
	#if MORECOLOR_PATCH
	[SchemeMid]  = { "#585b70", "#f5c2e7" },
	#endif // MORECOLOR_PATCH
	#if HIGHLIGHT_PATCH || FUZZYHIGHLIGHT_PATCH
	[SchemeSelHighlight]  = { "#585b70", "#cdd6f4" },
	[SchemeNormHighlight] = { "#585b70", "#cdd6f4" },
	#endif // HIGHLIGHT_PATCH | FUZZYHIGHLIGHT_PATCH
	#if HIGHPRIORITY_PATCH
