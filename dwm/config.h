...
static const char *fonts[]     = {"JetBrains Mono:weight=bold:size=8:antialias=true:hinting=true",
                                  "Hack:size=8:antialias=true:autohint=true",
                                  "Iosevka for Powerline:size=10:antialias=true:autohint=true"
						     	};
static const char col_1[]  = "#cba6f7"; /* background color of bar */
static const char col_2[]  = "#9399b2"; /* border color unfocused windows */
static const char col_3[]  = "#45475a"; /* text color */
static const char col_4[]  = "#f5c2e7"; /* border color focused windows and tags */
/* bar opacity
...
static Keychord keychords[] = {
	...
	{1, {{MODKEY|Mod1Mask, XK_l}},		 spawn,			  SHCMD("slock") },
